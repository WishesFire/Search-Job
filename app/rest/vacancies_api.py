...
from .handlers import create_vacancy_post_args, delete_vacancy_post_args
...
class VacancyAPI(Resource):
    ...
    def post(cls, category_slug):
        ...
        try:
            ...
            args = create_vacancy_post_args.parse_args()
            name = args.get("name")
    ...
    def delete(cls, category_slug):
        ...
        try:
            user_id = get_jwt_identity()
            args = delete_vacancy_post_args.parse_args()
            name = args.get("name")
